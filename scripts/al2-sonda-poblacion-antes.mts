...
import { LANGUAGE_DECLS } from "../scratchpad-al2/src0/server/services/code-analyzer.js";
import { deriveCapabilities } from "../scratchpad-al2/src0/server/services/detect/capabilities.js";
import { detector as temporaryFieldDetector } from "../scratchpad-al2/src0/server/services/detect/intra-file/temporary-field.js";
import { fileUnitFrom, nodeSetsFor, parseRoot, testContext } from "../scratchpad-al2/src0/server/services/detect/testing.js";
import type { Finding, RawFinding, RepoUnit } from "../scratchpad-al2/src0/server/services/detect/types.js";
import type { DerivedNodeSets } from "../scratchpad-al2/src0/server/services/code-grammar.js";
import { EMPTY_NEIGHBORHOOD } from "../scratchpad-al2/src0/server/services/graph/neighborhood.js";
import { HYPOTHESES } from "../scratchpad-al2/src0/server/services/hypotheses/registry.js";
import type { HypothesisContext } from "../scratchpad-al2/src0/server/services/hypotheses/types.js";
