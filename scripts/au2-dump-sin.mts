 ...
 *
 * Corre `analyzeRepo` sobre la COPIA CONGELADA `scratchpad-au2/src0-sin` (el arbol
...
const S0 = "../scratchpad-au2/src0-sin";
...
const edm: any = { startExtractDuplicatedMethodTrace: () => {}, takeExtractDuplicatedMethodTrace: () => [] };
const pud: any = { startPullUpDuplicatedMemberTrace: () => {}, takePullUpDuplicatedMemberTrace: () => [] };
