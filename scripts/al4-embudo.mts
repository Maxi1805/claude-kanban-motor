/**
 * OLA AL, FRENTE AL4 — EL EMBUDO Y LOS RASGOS DE FORMA DE LAS TRES ANCLAS DE
 * STRATEGY.
 *
 ...
 *
 * Uso: npx tsx scripts/al4-embudo.mts <dir-repo> <traza.json> <volcado.json>
 */
...
if (!dir || !outTraza || !outVolcado) {
  console.error("Uso: npx tsx scripts/al4-embudo.mts <dir-repo> <traza.json> <volcado.json>");
  process.exit(1);
}

const t0 = performance.now();
startStrategyTrace();
const a = await analyzeRepo({ dir, repoName: "al4", limits: { maxFindings: "unlimited" } });
