 ...
 * (`scratchpad-ak1/src0`, byte a byte igual a `src/` al abrir la ola) y prende
...
const { analyzeRepo } = await import("../scratchpad-ak1/src0/server/services/code-analyzer.js");
const { stableFindingId } = await import("../scratchpad-ak1/src0/server/services/code-finding-ids.js");
const { startStateTrace, takeStateTrace } = await import("../scratchpad-ak1/src0/server/services/hypotheses/state.js");
