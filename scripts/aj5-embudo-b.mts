 ...
 * (`scratchpad-aj5/src0`, byte a byte igual a `src/` al abrir la ola) y prende
...
const { analyzeRepo } = await import("../scratchpad-aj5/srcB/server/services/code-analyzer.js");
const { stableFindingId } = await import("../scratchpad-aj5/srcB/server/services/code-finding-ids.js");
const { startStateTrace, takeStateTrace } = await import("../scratchpad-aj5/srcB/server/services/hypotheses/state.js");
...
startStateTrace();
const a: any = await analyzeRepo({ dir, repoName: "aj5", limits: { maxFindings: "unlimited" } } as any);
