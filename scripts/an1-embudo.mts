/**
 * OLA AM, FRENTE AM2 (copia de an1-embudo.mts, misma lógica, ÁRBOL CONGELADO src0) — EL EMBUDO Y LOS RASGOS DE FORMA DE LAS TRES ANCLAS DE
 * STRATEGY.
 *
 ...
 *
 * Uso: npx tsx scripts/an1-embudo.mts <dir-repo> <traza.json> <volcado.json>
 */
...
if (!dir || !outTraza || !outVolcado) {
  console.error("Uso: npx tsx scripts/an1-embudo.mts <dir-repo> <traza.json> <volcado.json>");
  process.exit(1);
}
